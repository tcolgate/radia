...
func (x GHSMessage_Type) Enum() *GHSMessage_Type {
	p := new(GHSMessage_Type)
	*p = x
	return p
}
func (x GHSMessage_Type) String() string {
	return proto1.EnumName(GHSMessage_Type_name, int32(x))
}
func (x *GHSMessage_Type) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(GHSMessage_Type_value, data, "GHSMessage_Type")
	if err != nil {
		return err
	}
	*x = GHSMessage_Type(value)
	return nil
}
...
func (x GHSMessage_Initiate_NodeState) Enum() *GHSMessage_Initiate_NodeState {
	p := new(GHSMessage_Initiate_NodeState)
	*p = x
	return p
}
func (x GHSMessage_Initiate_NodeState) String() string {
	return proto1.EnumName(GHSMessage_Initiate_NodeState_name, int32(x))
}
func (x *GHSMessage_Initiate_NodeState) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(GHSMessage_Initiate_NodeState_value, data, "GHSMessage_Initiate_NodeState")
	if err != nil {
		return err
	}
	*x = GHSMessage_Initiate_NodeState(value)
	return nil
}

type GHSMessage struct {
	Type             *GHSMessage_Type       `protobuf:"varint,1,opt,name=type,enum=proto.GHSMessage_Type" json:"type,omitempty"`
...
func (m *GHSMessage) String() string { return proto1.CompactTextString(m) }
func (*GHSMessage) ProtoMessage()    {}

func (m *GHSMessage) GetType() GHSMessage_Type {
	if m != nil && m.Type != nil {
		return *m.Type
	}
	return GHSMessage_CONNECT
}
...
func (m *GHSMessage_Weight) Reset()         { *m = GHSMessage_Weight{} }
...
func (m *GHSMessage_Weight) GetLsnID() string {
	if m != nil && m.LsnID != nil {
		return *m.LsnID
	}
	return ""
}

func (m *GHSMessage_Weight) GetMsnID() string {
	if m != nil && m.MsnID != nil {
		return *m.MsnID
	}
	return ""
}
...
func (m *GHSMessage_Connect) String() string { return proto1.CompactTextString(m) }
func (*GHSMessage_Connect) ProtoMessage()    {}

func (m *GHSMessage_Connect) GetLevel() uint32 {
...
func (m *GHSMessage_Initiate) String() string { return proto1.CompactTextString(m) }
func (*GHSMessage_Initiate) ProtoMessage()    {}

func (m *GHSMessage_Initiate) GetLevel() uint32 {
	if m != nil && m.Level != nil {
		return *m.Level
	}
	return 0
...
func (m *GHSMessage_Initiate) GetFragment() *GHSMessage_Weight {
	if m != nil {
		return m.Fragment
	}
	return nil
...
func (m *GHSMessage_Test) String() string { return proto1.CompactTextString(m) }
func (*GHSMessage_Test) ProtoMessage()    {}

func (m *GHSMessage_Test) GetLevel() uint32 {
	if m != nil && m.Level != nil {
		return *m.Level
	}
	return 0
...
func (m *GHSMessage_Test) GetFragment() *GHSMessage_Weight {
	if m != nil {
		return m.Fragment
	}
	return nil
...
func (m *GHSMessage_Accept) String() string { return proto1.CompactTextString(m) }
...
func (m *GHSMessage_Reject) String() string { return proto1.CompactTextString(m) }
func (*GHSMessage_Reject) ProtoMessage()    {}

type GHSMessage_Report struct {
	Weight           *GHSMessage_Weight `protobuf:"bytes,1,opt,name=weight" json:"weight,omitempty"`
	XXX_unrecognized []byte             `json:"-"`
}

func (m *GHSMessage_Report) Reset()         { *m = GHSMessage_Report{} }
func (m *GHSMessage_Report) String() string { return proto1.CompactTextString(m) }
func (*GHSMessage_Report) ProtoMessage()    {}

func (m *GHSMessage_Report) GetWeight() *GHSMessage_Weight {
	if m != nil {
		return m.Weight
	}
	return nil
...
func (m *GHSMessage_ChangeRoot) String() string { return proto1.CompactTextString(m) }
func (*GHSMessage_ChangeRoot) ProtoMessage()    {}

func init() {
	proto1.RegisterEnum("proto.GHSMessage_Type", GHSMessage_Type_name, GHSMessage_Type_value)
	proto1.RegisterEnum("proto.GHSMessage_Initiate_NodeState", GHSMessage_Initiate_NodeState_name, GHSMessage_Initiate_NodeState_value)
}
